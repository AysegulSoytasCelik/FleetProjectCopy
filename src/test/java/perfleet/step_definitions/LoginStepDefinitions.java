...
public class LoginStepDefinitions {
    ...
    public void the_user_logs_in_as_a_driver() {
        loginPage.inputUsername.sendKeys(ConfigurationReader.getProperty("driver.username"));
        loginPage.inputPassword.sendKeys(ConfigurationReader.getProperty("all.password"));
    ...
    public void the_user_logs_in_as_a_sales_manager() {
        loginPage.inputUsername.sendKeys(ConfigurationReader.getProperty("sales.manager.username"));
        loginPage.inputPassword.sendKeys(ConfigurationReader.getProperty("all.password"));
        loginPage.loginButton.click();
    }
    ...
    public void the_user_logs_in_as_a_store_manager() {
        loginPage.inputUsername.sendKeys(ConfigurationReader.getProperty("store.manager.username"));
        loginPage.inputPassword.sendKeys(ConfigurationReader.getProperty("all.password"));
        loginPage.loginButton.click();
    }
    ...
    public void the_user_enters_invalid_username_and_password() {
        loginPage.inputUsername.sendKeys(ConfigurationReader.getProperty("invalid.username"));
        loginPage.inputPassword.sendKeys(ConfigurationReader.getProperty("invalid.password"));
        loginPage.loginButton.click();
